...
<?php if ($attention) { ?>
<div class="attention"><?php echo $attention; ?><img src="catalog/view/theme/xtremeshop/image/close2.png" alt="" class="close" /></div>
<?php } ?>
<?php if ($success) { ?>
<div class="success"><?php echo $success; ?><img src="catalog/view/theme/xtremeshop/image/close2.png" alt="" class="close" /></div>
<?php } ?>
<?php if ($error_warning) { ?>
<div class="warning"><?php echo $error_warning; ?><img src="catalog/view/theme/xtremeshop/image/close2.png" alt="" class="close" /></div>
<?php } ?>

<div class="page-name"><?php echo $heading_title; ?> <?php if ($weight) { ?>
      &nbsp;(<?php echo $weight; ?>)
      <?php } ?></div>
      ...
      <table>
        ...
        <tbody>
          ...
          <tr>
            ...
            <td class="quantity"><div style="float:left;"><input type="text" name="quantity[<?php echo $product['key']; ?>]" value="<?php echo $product['quantity']; ?>" size="1" /></div>
            <div class="quantity-icons">
              &nbsp;
              <input type="image" src="catalog/view/theme/xtremeshop/image/update2.png" alt="<?php echo $button_update; ?>" id="update-button" title="<?php echo $button_update; ?>" />
              &nbsp;<a href="<?php echo $product['remove']; ?>"><img src="catalog/view/theme/xtremeshop/image/remove.png" alt="<?php echo $button_remove; ?>" title="<?php echo $button_remove; ?>" /></a>
            </div></td>
          ...
          <tr>
            ...
            <td class="quantity"><input type="text" name="" value="1" size="1" disabled="disabled" />
              &nbsp;<a href="<?php echo $vouchers['remove']; ?>"><img src="catalog/view/theme/xtremeshop/image/remove.png" alt="<?php echo $text_remove; ?>" title="<?php echo $button_remove; ?>" /></a></td>
