...
<?php if ($thumb) { ?>
      <div class="image"><a href="<?php echo $popup; ?>" class="colorbox" style="display:block; background-image:url('<?php echo $thumb; ?>'); background-position:center center;"></a></div>

<?php } ?>
      <?php if ($images) { ?>
      <div class="image-additional">
        <?php foreach ($images as $image) { ?>
 <div class="small-image"><a href="<?php echo $image['popup']; ?>" class="colorbox" style="display:block; background-image:url('<?php echo $image['thumb']; ?>'); background-position:center center;"></a></div>
 <?php } ?>
<div class="clear"></div>
      </div>
      <?php } ?>
...
<ul>
        ...
        <?php if ($tags) { ?><!--li><span><?php echo $text_tags; ?></span> <?php foreach ($tags as $tag) { ?> <a href="<?php echo $tag['href']; ?>"><?php echo $tag['tag']; ?></a>, <?php } ?></li-->  <?php } ?>
...
<?php if ($price) { ?>
     ...
     <div class="price">
        <?php if (!$special) { ?>
        <div class="price-amount"><?php echo str_replace('.00','',$price); ?></div>
        <?php if ($tax) { ?>
        <span class="price-tax"><?php echo $text_tax; ?> <?php echo $tax; ?></span>
        <?php } ?>

        <?php } else { ?>
        <div class="price-amount"><?php echo str_replace('.00','',$special); ?></div>
...
<?php if ($review_status) { ?>
      <div class="review">
          <div class="reviews-stars"><img src="catalog/view/theme/xtremeshop/image/stars-<?php echo $rating; ?>.png" alt="<?php echo $reviews; ?>" /></div> <div class="reviews-number"><?php echo $reviews; ?></div>
      </div>
<div class="clear"></div>
      <?php } ?>
...
<div class="box-bottom">
  <div class="box-title"><a href="<?php echo $product['href']; ?>"><?php if( strlen( $product['name'] ) < 22 ) { echo $product['name']; } else { echo substr( $product['name'],0,19 )."..."; } ?></a></div><!--box-title ends-->
...
$('#button-cart').bind('click', function() {
	$.ajax({
		...
		success: function(json) {
			...
			if (json['success']) {
				$('#notification').html('<div class="success" style="display: none;">' + json['success'] + '<img src="catalog/view/theme/xtremeshop/image/close2.png" alt="" class="close" /></div>');
